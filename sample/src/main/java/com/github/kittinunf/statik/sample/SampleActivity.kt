            ...
            section {
                ...
                row {
                    ...
                    primaryTextAttribute {
                        color = String.format("#%06X", 0xFFFFFF and resources.getColor(R.color.colorAccent))
                    }
                    secondaryText = "Adjustable Secondary"
                    secondaryTextAttribute {
                        color = String.format("#%06X", 0xFFFFFF and resources.getColor(android.R.color.holo_orange_dark))
