...
class FooterTextSupplementaryViewHolder(view: View) : TextSupplementaryViewHolder(view) {
    ...
    override fun bind(item: TextSupplementaryItemRepresentable) {
        ...
        if (textSetup == null) {
            TextViewCompat.setTextAppearance(textView, R.style.Widget_Statik_Base_FooterTextItem)
        } else {
            textSetup(textView)
        }
    }
